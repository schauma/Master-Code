...
% Beta values to try
% 1 : beta = 0.51
% 2 : beta = 0.522 // das threshold ding
% 3 : beta = 0.053
% 4 : beta = 0.5001
% 5 : beta = 0.511 // das halbe threshold ding
% 6 : beta = 0.5055 // verhaeltnis. aber mit der veranderten Threshold
% fuers lernene
% 7 : beta = 0.54 zo hoch//
% 8 : beta = 0.535 ok//
% 9 : beta = 0.525 auch ok etwas riskier
% 10 : beta = 0.55 %Definitiv zu hoch
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
