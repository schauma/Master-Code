function [xE,V,rate,spikes,error,forward_signal,rDec,iDec] = controller_without_error(A,B,C,xT,dxT,Nneuron,dt,M,rDec,iDec,mu,nu,lambdaD,sigmaV,lambdaV)
% A system matrix
% B input matrix
% C output matrix
% xT Target
...
%     spikes(ff,i+1) = 1;
    ...
    u(:,i+1) = 1/lambdaD*rDec*rate(:,i+1) + iDec*spikes(:,i+1);
    ...
    forward_signal(:,i+1) = (dxT(:,i+1)-A*xT(:,i+1));
