...
Wf_true = -F'*F - mu*eye(n_neuron);
Ws_true = F'*(A+lambdaD*eye(J))*F;
...
[xE_true,~,~,~,~]= simulate_network(A,c,F,Threshold,n_time,dt,...
...
fast_drop_rate =0*0.09;%compare wf with .7 and .5 drop rate.what is the critical change?
